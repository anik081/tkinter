...
def submitLogin(logImApp,nameEntry,passEntry):
    ...
    if name =="" or password == "":
        ...
        sql="""
        SELECT COUNT(*) FROM admin WHERE user_name=? AND password=?
        """
...
def userLogin():
    ...
    titleLabel = Label(logImApp,text="Login as Admin Here!", fg="black", font="times 12 bold")
